...
const releaseRoute = (0, express_1.Router)();
/**
 * @swagger
 * /release/create:
 *   post:
 ...
 */
releaseRoute.post("/create", auth_middleware_1.AuthMiddleware, controllers_1.ReleaseController.createRelease);
releaseRoute.put("/update/:id", auth_middleware_1.AuthMiddleware, controllers_1.ReleaseController.updateRelease);
releaseRoute.delete("/delete/:id", controllers_1.ReleaseController.deleteRelease);
releaseRoute.get("/all", auth_middleware_1.AuthMiddleware, controllers_1.ReleaseController.getAllReleases);
releaseRoute.get("/getById/:releaseId", auth_middleware_1.AuthMiddleware, controllers_1.ReleaseController.FindReleaseById);
// releaseRoute.post(
//   "/:releaseId/package",
//   upload.array("files"),
//   AuthMiddleware,
