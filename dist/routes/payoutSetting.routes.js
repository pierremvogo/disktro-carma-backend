...
const payoutRoute = (0, express_1.Router)();
/**
 * @swagger
 * tags:
 *   - name: Payout
 ...
 */
payoutRoute.get("/get/me", auth_middleware_1.AuthMiddleware, controllers_1.PayoutSettingsController.GetMyPayoutSettings);
/**
 * @swagger
 * /payout/create/me:
 *   post:
 ...
 *         description: Erreur serveur
 */
payoutRoute.post("/create/me", auth_middleware_1.AuthMiddleware, controllers_1.PayoutSettingsController.UpsertMyPayoutSettings);
exports.default = payoutRoute;
