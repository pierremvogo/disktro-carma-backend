...
const artistAdminRoute = (0, express_1.Router)();
/**
 * @swagger
...
artistAdminRoute.post("/create/:adminId/:artistId", controllers_1.ArtistAdminController.createArtistAdmin);
// Retrieve artistAdmin by userId and artistId
artistAdminRoute.get("/get/:userId/:artistId", controllers_1.ArtistAdminController.FindArtistAdminByUserIdAndArtistId);
// Retrieve artistAdmin by userId
artistAdminRoute.get("/get/:userId", controllers_1.ArtistAdminController.FindArtistAdminByUserId);
// Retrieve artistAdmin by artistId
artistAdminRoute.get("/get/:artistId", controllers_1.ArtistAdminController.FindArtistAdminByArtistId);
// Retrieve artistAdmin by id
artistAdminRoute.get("/get/:id", controllers_1.ArtistAdminController.FindArtistAdminById);
exports.default = artistAdminRoute;
