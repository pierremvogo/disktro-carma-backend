...
const epRoute = (0, express_1.Router)();
/**
 * @swagger
 * tags:
 *   - name: Ep
 ...
 *         description: Erreur serveur
 */
epRoute.post("/create", auth_middleware_1.AuthMiddleware, controllers_1.EpController.create);
epRoute.get("/getById/:id", auth_middleware_1.AuthMiddleware, controllers_1.EpController.FindEpById);
epRoute.get("/getAll", auth_middleware_1.AuthMiddleware, controllers_1.EpController.FindAllEps);
epRoute.get("/getByUser/:userId", auth_middleware_1.AuthMiddleware, controllers_1.EpController.FindEpsByUserId);
epRoute.put("/:id", controllers_1.EpController.UpdateEp);
epRoute.delete("/:id", controllers_1.EpController.DeleteEp);
exports.default = epRoute;
