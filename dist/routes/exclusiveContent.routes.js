...
const exclusiveContentRoute = (0, express_1.Router)();
/**
 * @swagger
 * tags:
 ...
 *         description: Erreur serveur
 */
exclusiveContentRoute.post("/create", auth_middleware_1.AuthMiddleware, controllers_1.ExclusiveContentController.Create);
exclusiveContentRoute.get("/getById/:id", auth_middleware_1.AuthMiddleware, controllers_1.ExclusiveContentController.FindById);
exclusiveContentRoute.get("/getAll", auth_middleware_1.AuthMiddleware, controllers_1.ExclusiveContentController.FindAll);
exclusiveContentRoute.get("/getByArtist/:artistId", auth_middleware_1.AuthMiddleware, controllers_1.ExclusiveContentController.FindByArtistId);
exclusiveContentRoute.put("/:id", auth_middleware_1.AuthMiddleware, controllers_1.ExclusiveContentController.Update);
exclusiveContentRoute.delete("/:id", auth_middleware_1.AuthMiddleware, controllers_1.ExclusiveContentController.Delete);
exports.default = exclusiveContentRoute;
