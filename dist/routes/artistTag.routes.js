...
const artistsTagRoute = (0, express_1.Router)();
/**
 * @swagger
...
artistsTagRoute.post("/create/:tagId/:artistId", controllers_1.ArtistTagController.create);
// Retrieve artistTag by artistId and tag Ig
artistsTagRoute.get("/get/:tagId/:artistId", controllers_1.ArtistTagController.FindArtistTagByArtistIdAndTagId);
// Retrieve artistTag by artistId
artistsTagRoute.get("/get/:artistId", controllers_1.ArtistTagController.FindArtistTagByArtistId);
// Retrieve artistTag by tagId
artistsTagRoute.get("/get/:tagId", controllers_1.ArtistTagController.FindArtistTagBytagId);
// Retrieve artistTag by id
artistsTagRoute.get("/get/:id", controllers_1.ArtistTagController.FindArtistTagById);
exports.default = artistsTagRoute;
