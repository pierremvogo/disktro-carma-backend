 ...
 *         description: Erreur serveur
 */
stripeRoute.post("/checkout/subscription", auth_middleware_1.AuthMiddleware, controllers_1.StripeController.createSubscriptionCheckoutSession);
/**
 * @swagger
 * /stripe/portal:
 *   post:
 ...
 *         description: Erreur serveur
 */
stripeRoute.post("/portal", auth_middleware_1.AuthMiddleware, controllers_1.StripeController.createCustomerPortalSession);
/**
 * @swagger
 ...
 *         description: Erreur serveur
 */
stripeRoute.post("/subscription/:artistId/cancel", auth_middleware_1.AuthMiddleware, controllers_1.StripeController.cancelSubscriptionForArtist);
