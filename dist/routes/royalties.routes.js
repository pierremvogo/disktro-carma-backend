...
const royaltiesRoute = (0, express_1.Router)();
/**
 * @swagger
 * tags:
 *   - name: Royalties
 ...
 */
royaltiesRoute.get("/artist/me/summary", auth_middleware_1.AuthMiddleware, controllers_1.RoyaltiesController.GetMyRoyaltiesSummary);
/**
 * @swagger
 ...
 *         description: Erreur serveur
 */
royaltiesRoute.get("/artist/me/by-track", auth_middleware_1.AuthMiddleware, controllers_1.RoyaltiesController.GetMyRoyaltiesByTrack);
exports.default = royaltiesRoute;
