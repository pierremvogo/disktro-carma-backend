 ...
 *         description: Erreur serveur
 */
trackRoute.post("/create", auth_middleware_1.AuthMiddleware, controllers_1.TrackController.Create);
trackRoute.get("/getById/:id", auth_middleware_1.AuthMiddleware, controllers_1.TrackController.FindTrackById);
trackRoute.get("/getAll", auth_middleware_1.AuthMiddleware, controllers_1.TrackController.FindAllTrack);
trackRoute.get("/getByMoodName", auth_middleware_1.AuthMiddleware, controllers_1.TrackController.FindTracksByMoodName);
trackRoute.get("/getByGenreName", auth_middleware_1.AuthMiddleware, controllers_1.TrackController.FindTracksByGenreName);
trackRoute.get("/topStreams", auth_middleware_1.AuthMiddleware, controllers_1.TrackController.FindTopStreamedTracksFeatured);
trackRoute.get("/newReleases", auth_middleware_1.AuthMiddleware, controllers_1.TrackController.FindNewReleases);
trackRoute.get("/getByArtist/:artistId", auth_middleware_1.AuthMiddleware, controllers_1.TrackController.FindTracksByArtistId);
trackRoute.get("/getByRelease/:releaseId", auth_middleware_1.AuthMiddleware, controllers_1.TrackController.FindTracksByReleaseId);
trackRoute.get("/getByAlbum/:albumId", auth_middleware_1.AuthMiddleware, controllers_1.TrackController.FindTracksByAlbumId);
trackRoute.get("/getByUser/:userId", auth_middleware_1.AuthMiddleware, controllers_1.TrackController.FindTrackByUserId);
trackRoute.put("/:id", controllers_1.TrackController.UpdateTrack);
trackRoute.delete("/:id", controllers_1.TrackController.DeleteTrack);
