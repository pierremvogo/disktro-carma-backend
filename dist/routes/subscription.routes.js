...
const subscriptionRoute = (0, express_1.Router)();
/**
 * @swagger
 * tags:
 *   - name: Subscription
 ...
 */
subscriptionRoute.post("/create", auth_middleware_1.AuthMiddleware, controllers_1.SubscriptionController.CreateSubscription);
/**
 * @swagger
 ...
 */
subscriptionRoute.get("/artist/me/recent", auth_middleware_1.AuthMiddleware, controllers_1.SubscriptionController.GetMyRecentActiveSubscribers);
/**
 * @swagger
 ...
 *         description: Erreur serveur
 */
subscriptionRoute.get("/artist/me/by-location", auth_middleware_1.AuthMiddleware, controllers_1.SubscriptionController.GetMyActiveSubscriptionsByLocation);
/**
 * @swagger
 ...
 *         description: Erreur serveur
 */
subscriptionRoute.get("/artist/me/stats", auth_middleware_1.AuthMiddleware, controllers_1.SubscriptionController.GetMySubscriptionStats);
/**
 * @swagger
 ...
 *         description: "Erreur serveur"
 */
subscriptionRoute.get("/artist/:artistId/status", auth_middleware_1.AuthMiddleware, controllers_1.SubscriptionController.GetSubscriptionStatus);
/**
 * @swagger
 ...
 *         description: "Erreur serveur"
 */
subscriptionRoute.post("/artist/:artistId/subscribe", auth_middleware_1.AuthMiddleware, controllers_1.SubscriptionController.SubscribeToArtist);
/**
 * @swagger
 ...
 *         description: "Erreur serveur"
 */
subscriptionRoute.post("/artist/:artistId/unsubscribe", auth_middleware_1.AuthMiddleware, controllers_1.SubscriptionController.UnsubscribeFromArtist);
/**
 * @swagger
 ...
 *         description: Aucune souscription trouvée
 */
subscriptionRoute.get("/plan/:planId", auth_middleware_1.AuthMiddleware, controllers_1.SubscriptionController.GetSubscriptionsByPlanId);
/**
 * @swagger
 ...
 */
subscriptionRoute.put("/update/:id", auth_middleware_1.AuthMiddleware, controllers_1.SubscriptionController.UpdateSubscription);
/**
 * @swagger
 ...
 *         description: Souscription non trouvée
 */
subscriptionRoute.delete("/delete/:id", auth_middleware_1.AuthMiddleware, controllers_1.SubscriptionController.DeleteSubscription);
/**
 * @swagger
 * /subscription:
 *   get:
 ...
 */
subscriptionRoute.get("/", auth_middleware_1.AuthMiddleware, controllers_1.SubscriptionController.GetAllSubscriptions);
/**
 * @swagger
 * /subscription/{id}:
 *   get:
 ...
 *         description: Souscription non trouvée
 */
subscriptionRoute.get("/:id", auth_middleware_1.AuthMiddleware, controllers_1.SubscriptionController.GetSubscriptionById);
