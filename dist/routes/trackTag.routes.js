...
const trackTagRoute = (0, express_1.Router)();
/**
 * @swagger
 ...
 */
// Create new trackTag
trackTagRoute.post("/create/:tagId/:trackId", controllers_1.TrackTagController.createTrackTag);
// Retrieve trackTag by tagId and trackId
trackTagRoute.get("/getByTagAndTrack/:tagId/:trackId", controllers_1.TrackTagController.FindTrackTagByTrackIdAndTagId);
// Retrieve trackTag by trackId
trackTagRoute.get("/getByTrackId/:trackId", controllers_1.TrackTagController.FindTrackTagByTrackId);
// Retrieve trackTag by tagId
trackTagRoute.get("/getByTagId/:tagId", controllers_1.TrackTagController.FindTrackTagByTagId);
// Retrieve trackTag by id
trackTagRoute.get("/getById/:id", controllers_1.TrackTagController.FindTrackTagById);
exports.default = trackTagRoute;
