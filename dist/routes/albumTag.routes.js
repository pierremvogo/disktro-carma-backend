...
const albumTagRoute = (0, express_1.Router)();
/**
 * @swagger
 ...
 */
// Create new albumTag
albumTagRoute.post("/create/:tagId/:albumId", controllers_1.AlbumTagController.createAlbumTag);
// Retrieve albumTag by albumId and TagId
albumTagRoute.get("/get/:tagId/:albumId", controllers_1.AlbumTagController.FindAlbumTagByAlbumIdAndTagId);
// Retrieve albumTag by albumId
albumTagRoute.get("/get/albumId", controllers_1.AlbumTagController.FindAlbumTagByAlbumId);
// Retrieve albumTag by tagId
albumTagRoute.get("/get/tagId", controllers_1.AlbumTagController.FindAlbumTagByTagId);
// Retrieve albumTag by Id
albumTagRoute.get("/get/id", controllers_1.AlbumTagController.FindAlbumTagById);
exports.default = albumTagRoute;
