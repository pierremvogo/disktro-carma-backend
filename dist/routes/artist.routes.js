...
const artistsRoute = (0, express_1.Router)();
/**
 * @swagger
 * /artists/create:
 *   post:
 ...
 */
// Create a new artist
artistsRoute.post("/create", auth_middleware_1.AuthMiddleware, controllers_1.ArtistController.CreateArtist);
// Retrieve all artists
artistsRoute.get("/get", auth_middleware_1.AuthMiddleware, controllers_1.ArtistController.FindAllArtists);
// Retrieve a single artist with id
artistsRoute.get("/getById/:id", auth_middleware_1.AuthMiddleware, controllers_1.ArtistController.FindArtistById);
// Retrieve artist by slug
artistsRoute.get("/getBySlug/:slug", auth_middleware_1.AuthMiddleware, controllers_1.ArtistController.FindArtistBySlug);
// Retrieve artistAdmin By UserId
artistsRoute.get("/getAdmin/:userId", auth_middleware_1.AuthMiddleware, controllers_1.ArtistController.FindArtistsAdminedByUser);
// Retrieve artist By UserEmail
artistsRoute.get("/getByUserEmail/:userEmail", auth_middleware_1.AuthMiddleware, controllers_1.ArtistController.FindArtistsByUserEmail);
// Retrieve artist with Tag
artistsRoute.get("/getWithTag/:tagId", auth_middleware_1.AuthMiddleware, controllers_1.ArtistController.FindArtistsAdminedByUser);
artistsRoute.put("/:id", controllers_1.ArtistController.UpdateArtist);
artistsRoute.delete("/:id", controllers_1.ArtistController.DeleteArtist);
exports.default = artistsRoute;
