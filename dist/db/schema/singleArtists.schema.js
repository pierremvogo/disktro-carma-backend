...
exports.singleArtistsRelations = exports.singleArtists = void 0;
const drizzle_orm_1 = require("drizzle-orm");
const mysql_core_1 = require("drizzle-orm/mysql-core");
const schema = __importStar(require("./index"));
const nanoid_1 = require("nanoid");
// import { singles, tracks, users, artistTags } from '.'
exports.singleArtists = (0, mysql_core_1.mysqlTable)("single_artists", {
...
}, (t) => [(0, mysql_core_1.uniqueIndex)("unique_artist_single").on(t.artistId, t.singleId)]);
exports.singleArtistsRelations = (0, drizzle_orm_1.relations)(exports.singleArtists, ({ one }) => ({
    single: one(schema.singles, {
        relationName: "single",
        fields: [exports.singleArtists.singleId],
        references: [schema.singles.id],
    }),
    artist: one(schema.users, {
        relationName: "users",
        fields: [exports.singleArtists.artistId],
