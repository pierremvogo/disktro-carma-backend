...
exports.epArtistsRelations = exports.epArtists = void 0;
const drizzle_orm_1 = require("drizzle-orm");
const mysql_core_1 = require("drizzle-orm/mysql-core");
const schema = __importStar(require("./index"));
const nanoid_1 = require("nanoid");
// import { eps, tracks, users, artistTags } from '.'
exports.epArtists = (0, mysql_core_1.mysqlTable)("ep_artists", {
...
}, (t) => [(0, mysql_core_1.uniqueIndex)("unique_artist_ep").on(t.artistId, t.epId)]);
exports.epArtistsRelations = (0, drizzle_orm_1.relations)(exports.epArtists, ({ one }) => ({
    ep: one(schema.eps, {
        relationName: "ep",
        fields: [exports.epArtists.epId],
        references: [schema.eps.id],
    }),
    artist: one(schema.users, {
        relationName: "users",
        fields: [exports.epArtists.artistId],
