...
exports.trackEpsRelations = exports.trackEps = void 0;
const drizzle_orm_1 = require("drizzle-orm");
const mysql_core_1 = require("drizzle-orm/mysql-core");
const schema = __importStar(require("./index"));
const nanoid_1 = require("nanoid");
exports.trackEps = (0, mysql_core_1.mysqlTable)("track_eps", {
...
}, (t) => [(0, mysql_core_1.uniqueIndex)("ep_track_unique_idx").on(t.epId, t.trackId)]);
exports.trackEpsRelations = (0, drizzle_orm_1.relations)(exports.trackEps, ({ one }) => ({
    track: one(schema.tracks, {
        relationName: "track",
        fields: [exports.trackEps.trackId],
        references: [schema.tracks.id],
    }),
    ep: one(schema.eps, {
        relationName: "ep",
        fields: [exports.trackEps.epId],
        references: [schema.eps.id],
    }),
}));
