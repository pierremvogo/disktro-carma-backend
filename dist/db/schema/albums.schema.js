...
exports.albumsTableInfo = exports.albumsRelations = exports.albums = void 0;
...
}, (table) => [(0, mysql_core_1.index)("album_slug_idx").on(table.slug)]);
exports.albumsRelations = (0, drizzle_orm_1.relations)(exports.albums, ({ one, many }) => ({
    user: one(schema.users, {
        fields: [exports.albums.userId],
...
exports.albumsTableInfo = (0, mysql_core_1.getTableConfig)(exports.albums);
