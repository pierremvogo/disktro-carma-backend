...
exports.trackTagsRelations = exports.trackTags = void 0;
const drizzle_orm_1 = require("drizzle-orm");
const mysql_core_1 = require("drizzle-orm/mysql-core");
const schema = __importStar(require("./index"));
const nanoid_1 = require("nanoid");
exports.trackTags = (0, mysql_core_1.mysqlTable)("track_tags", {
...
}, (t) => [(0, mysql_core_1.uniqueIndex)("track_tag_unique_idx").on(t.trackId, t.tagId)]);
exports.trackTagsRelations = (0, drizzle_orm_1.relations)(exports.trackTags, ({ one }) => ({
    track: one(schema.tracks, {
        fields: [exports.trackTags.trackId],
        references: [schema.tracks.id],
    }),
    tag: one(schema.tags, {
        fields: [exports.trackTags.tagId],
        references: [schema.tags.id],
    }),
}));
