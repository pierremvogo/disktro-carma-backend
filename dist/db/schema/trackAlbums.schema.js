...
exports.trackAlbumsRelations = exports.trackAlbums = void 0;
const drizzle_orm_1 = require("drizzle-orm");
const mysql_core_1 = require("drizzle-orm/mysql-core");
const schema = __importStar(require("./index"));
const nanoid_1 = require("nanoid");
exports.trackAlbums = (0, mysql_core_1.mysqlTable)("track_albums", {
...
}, (t) => [(0, mysql_core_1.uniqueIndex)("album_track_unique_idx").on(t.albumId, t.trackId)]);
exports.trackAlbumsRelations = (0, drizzle_orm_1.relations)(exports.trackAlbums, ({ one }) => ({
    track: one(schema.tracks, {
        relationName: "track",
        fields: [exports.trackAlbums.trackId],
        references: [schema.tracks.id],
    }),
    album: one(schema.albums, {
        relationName: "album",
        fields: [exports.trackAlbums.albumId],
        references: [schema.albums.id],
    }),
}));
