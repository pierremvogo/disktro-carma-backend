...
exports.singlesTableInfo = exports.singlesRelations = exports.singles = void 0;
const drizzle_orm_1 = require("drizzle-orm");
const mysql_core_1 = require("drizzle-orm/mysql-core");
const schema = __importStar(require("."));
const nanoid_1 = require("nanoid");
exports.singles = (0, mysql_core_1.mysqlTable)("singles", {
    ...
    audioUrl: (0, mysql_core_1.varchar)("audio_url", { length: 256 }).notNull(),
    audioFileName: (0, mysql_core_1.varchar)("audio_file_name", { length: 255 }).notNull(),
    // ============
    // Création / crédits
    // ============
...
}, (table) => [(0, mysql_core_1.index)("single_slug_idx").on(table.slug)]);
exports.singlesRelations = (0, drizzle_orm_1.relations)(exports.singles, ({ one, many }) => ({
    user: one(schema.users, {
        fields: [exports.singles.userId],
...
exports.singlesTableInfo = (0, mysql_core_1.getTableConfig)(exports.singles);
