...
exports.userTagsRelations = exports.userTags = void 0;
const drizzle_orm_1 = require("drizzle-orm");
const mysql_core_1 = require("drizzle-orm/mysql-core");
const schema = __importStar(require("./index"));
const nanoid_1 = require("nanoid");
exports.userTags = (0, mysql_core_1.mysqlTable)("user_tags", {
...
}, (t) => [(0, mysql_core_1.uniqueIndex)("user_tag_unique_idx").on(t.userId, t.tagId)]);
exports.userTagsRelations = (0, drizzle_orm_1.relations)(exports.userTags, ({ one }) => ({
    user: one(schema.users, {
        fields: [exports.userTags.userId],
        references: [schema.users.id],
    }),
    tag: one(schema.tags, {
        fields: [exports.userTags.tagId],
