...
exports.trackSinglesRelations = exports.trackSingles = void 0;
const drizzle_orm_1 = require("drizzle-orm");
const mysql_core_1 = require("drizzle-orm/mysql-core");
const schema = __importStar(require("./index"));
const nanoid_1 = require("nanoid");
exports.trackSingles = (0, mysql_core_1.mysqlTable)("track_singles", {
...
}, (t) => [(0, mysql_core_1.uniqueIndex)("single_track_unique_idx").on(t.singleId, t.trackId)]);
exports.trackSinglesRelations = (0, drizzle_orm_1.relations)(exports.trackSingles, ({ one }) => ({
    track: one(schema.tracks, {
        relationName: "track",
        fields: [exports.trackSingles.trackId],
        references: [schema.tracks.id],
    }),
    single: one(schema.singles, {
        relationName: "single",
        fields: [exports.trackSingles.singleId],
        references: [schema.singles.id],
    }),
}));
