...
exports.emailContent = {
    ...
    verifyEmail: {
        english: {
            ...
            html: (token) => baseLayout("Confirm your email", `
        ...
        spanish: {
            ...
            html: (token) => baseLayout("Confirma tu correo", `
        ...
        catalan: {
            ...
            html: (token) => baseLayout("Confirma el teu correu", `
    ...
    resetPassword: {
        english: {
            ...
            html: (url) => baseLayout("Reset your password", `
        ...
        spanish: {
            ...
            html: (url) => baseLayout("Restablecer contraseña", `
        ...
        catalan: {
            ...
            html: (url) => baseLayout("Restablir la contrasenya", `
