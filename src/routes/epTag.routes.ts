...
import { EpTagController } from "../controllers";
const epTagRoute = Router();
...
// Create new epTag
epTagRoute.post("/create/:tagId/:epId", EpTagController.createEpTag);

// Retrieve epTag by epId and TagId
epTagRoute.get("/get/:tagId/:epId", EpTagController.FindEpTagByEpIdAndTagId);

// Retrieve epTag by epId
epTagRoute.get("/get/epId", EpTagController.FindEpTagByEpId);

// Retrieve epTag by tagId
epTagRoute.get("/get/tagId", EpTagController.FindEpTagByTagId);

// Retrieve epTag by Id
epTagRoute.get("/get/id", EpTagController.FindEpTagById);

export default epTagRoute;
