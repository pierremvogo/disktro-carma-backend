 ...
 */
authsRoute.post("/login", UserController.LoginUser);
/**
 * @swagger
 ...
 */
authsRoute.get("/verify-email/:token", UserController.VerifyEmail);
 ...
 */
authsRoute.post("/request-password-reset", UserController.requestResetPassword);
 ...
 */
authsRoute.post("/reset-password/:token", UserController.resetPassword);
